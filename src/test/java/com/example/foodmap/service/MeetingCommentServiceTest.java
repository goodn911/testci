...
//        //given
//        MeetingCommentCreateRequestDto meetingCommentCreateRequestDto =
//                new MeetingCommentCreateRequestDto("모임 참가합니다.",1L);
//
//        //when
//       ;
...
//        });
//
//        assertThat(exception.getMessage()).isEqualTo("본인 댓글만 수정 할 수 있습니다.");
//    }
//    @Test
//    @DisplayName("댓글 삭제")
//    void 댓글삭제() {
...
//        });
//
//        assertThat(exception.getMessage()).isEqualTo("본인 댓글만 삭제 할 수있습니다.");
//    }
//
//    @Test
//    @DisplayName("계층댓글")
